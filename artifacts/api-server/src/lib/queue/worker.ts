...
import { enqueueFitAnalysisCycle, enqueueHygieneCycle, enqueueRefreshCycle, runJob } from "./handlers";
...
export function startQueueWorker(): void {
  ...
  every(HYGIENE_CYCLE_MS, "Queue: hygiene cycle could not be enqueued", enqueueHygieneCycle);
